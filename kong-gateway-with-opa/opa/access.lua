...
local function getDocument(input, conf)
    ...
    -- comments by Arshad for debugging
    kong.log.err("below is the input json and opa url")
    kong.log.err(opa_uri)
    kong.log.err(json_body)
    -- end of comments by Arshad
    ...
    -- comments by arshad
    kong.log.err("below is the error and response after POST request")
    kong.log.err(err)
    kong.log.err(res)
    --end of comments by arshad
